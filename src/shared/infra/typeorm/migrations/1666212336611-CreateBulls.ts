        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    {
                        type: "uuid",
                        name: "first_level_parent_id",
                        isNullable: true,
                    },
                    {
                        type: "uuid",
                        name: "second_level_parent_id",
                        isNullable: true,
                    },
                    {
                        type: "uuid",
                        name: "third_level_parent_id",
                        isNullable: true,
                    },
                ],
                foreignKeys: [
                    {
                        ...
                        columnNames: ["first_level_parent_id"],
                        onDelete: "RESTRICT",
                        onUpdate: "RESTRICT",
                    },
                    {
                        ...
                        referencedTableName: "bulls",
                        referencedColumnNames: ["id"],
                        columnNames: ["second_level_parent_id"],
                        onDelete: "RESTRICT",
                        onUpdate: "RESTRICT",
                    },
                    {
                        ...
                        referencedTableName: "bulls",
                        referencedColumnNames: ["id"],
                        columnNames: ["third_level_parent_id"],
                        onDelete: "RESTRICT",
                        onUpdate: "RESTRICT",
                    },
                ],
